...
figure(3)
step(Time_u , np.transpose(u[0]) + Uref[0].T,linewidth=1.5,color='dodgerblue',label='Linear speed [m/s]') 
step(Time_u , Uref[0].T,linewidth=0.8,label='Reference linear speed [m/s]',color='r') 
xlabel('Time [s]')
legend()
grid()
show()
...
figure(4)
step(Time_u , np.transpose(u[1]) + Uref[1].T,linewidth=1.5,label='Angular speed [m/s]',color='dodgerblue') 
step(Time_u , Uref[1].T,linewidth=0.8,label='Reference angular speed [m/s]', color='r') 
xlabel('Time [s]')
legend()
grid()
show()
